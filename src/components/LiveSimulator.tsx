...
export const LiveSimulator: React.FC<LiveSimulatorProps> = ({ lang }) => {
  ...
  return (
    <div className="bg-[#050C16] text-slate-100 rounded-3xl border border-cyan-500/40 p-5 sm:p-8 shadow-2xl relative overflow-hidden transition-all">
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 pb-5 border-b border-slate-800 relative z-10">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="text-base font-black font-tech tracking-wider text-white">
                MNK MISSION-CONTROL MULTI-ENGINE SIMULATOR
              </span>
              <span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 text-[10px] font-tech font-bold border border-emerald-500/30 flex items-center">
        ...
        <div className="flex flex-wrap items-center gap-1.5 p-1 rounded-2xl bg-slate-900/90 border border-slate-800 text-xs font-tech">
          <button
        ...
        {activeEngine === 'pisbot' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-7 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 space-y-3 font-tech text-xs">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-2.5">
                          <span
                            className={`w-2 h-2 rounded-full ${
                              isDropped ? 'bg-red-500' : isFailover ? 'bg-cyan-400' : 'bg-emerald-400'
                            }`}
                          ></span>
                          <div>
                        ...
                        <div className="text-right">
                          <div className={`font-bold ${isDropped ? 'text-red-400' : 'text-emerald-400'}`}>
              ...
              <div className="lg:col-span-5 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 flex flex-col justify-between space-y-4">
                <div>
                  <div className="text-xs font-tech text-cyan-400 uppercase tracking-wider mb-2 flex items-center">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 font-tech text-[11px] space-y-1.5">
                    <div className="flex justify-between">
                      <span className="text-slate-500">Autonomous Traceroute:</span>
                      <span className="text-cyan-300">15 Hops Verified</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">Failover SLA:</span>
                      <span className="text-emerald-400 font-bold">&lt; 800 ms Guarantee</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">Alarm Escalation:</span>
                      <span className="text-red-400 font-bold">Telegram / Webhook Direct</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-2 pt-2">
                  ...
                  {failoverActive && (
                    <button
                      onClick={resetPisbot}
                      className="py-2.5 px-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-cyan-300 font-tech font-bold text-xs border border-cyan-500/30 transition-all flex items-center space-x-1"
                    >
            ...
            <div className="bg-slate-950 rounded-2xl p-4 border border-cyan-500/20 font-tech text-xs space-y-1.5">
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="lg:col-span-8 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-2 text-xs font-tech">
                    ...
                    {[1, 2, 3, 4].map((cId) => (
                      <button
                        ...
                        className={`px-2 py-0.5 rounded text-[10px] ${
                          activeCamView === cId ? 'bg-red-600 text-white font-bold' : 'bg-slate-800 text-slate-400'
                        }`}
                      >
                        CAM 0{cId}
                      </button>
                ...
                <div className="flex items-center space-x-3 pt-1">
                  <button
                    ...
                    className="flex-1 py-2 px-3 rounded-xl bg-red-600 hover:bg-red-700 text-white font-tech font-bold text-xs transition-all flex items-center justify-center space-x-1.5"
                  >
                    <AlertTriangle className="w-3.5 h-3.5" />
                  ...
                  <button
                    ...
                    className="flex-1 py-2 px-3 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-tech font-bold text-xs transition-all flex items-center justify-center space-x-1.5"
                  >
              ...
              <div className="lg:col-span-4 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 flex flex-col justify-between space-y-4 font-tech text-xs">
                <div className="space-y-4">
                  <div className="text-cyan-400 border-b border-slate-800 pb-2 flex items-center justify-between text-[11px]">
                    <span>TENSORRT ENGINE HEALTH</span>
                    <span className="text-emerald-400">LATENCY: 4.2ms</span>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between text-slate-400 mb-1">
                      ...
                      <span className="text-white font-bold">{aiGpuLoad}%</span>
                    </div>
                    <div className="w-full bg-slate-950 h-2.5 rounded-full overflow-hidden">
                      <div
                        className={`h-full transition-all duration-500 ${
                          aiGpuLoad > 90 ? 'bg-red-500' : 'bg-cyan-400'
                        }`}
                  ...
                  <div>
                    <div className="flex justify-between text-slate-400 mb-1">
                      ...
                      <span className="text-white font-bold">5.4 GB (33%)</span>
                    </div>
                    <div className="w-full bg-slate-950 h-2.5 rounded-full overflow-hidden">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-2 text-[11px]">
                    <div className="flex justify-between">
                      ...
                      <span className="text-cyan-300">YOLOv8x + ONNX</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">Stream FPS:</span>
                      <span className="text-emerald-400 font-bold">59.8 FPS Steady</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">Active Camera Matrix:</span>
                      <span className="text-white font-bold">64 RTSP Feeds</span>
                    </div>
                  </div>
                </div>

                <div className="p-3 rounded-xl bg-cyan-950/40 border border-cyan-500/30 text-cyan-300 text-[10px]">
        ...
        {activeEngine === 'aegis' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
              ...
              <div className="lg:col-span-6 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 flex flex-col items-center justify-center space-y-4">
                <div className="w-full flex items-center justify-between text-xs font-tech text-cyan-400 border-b border-slate-800 pb-2">
                  <span>MALACCA STRAIT & JAVA SEA RADAR</span>
                  <span className="text-emerald-400">30+ TANKERS ON-GRID</span>
                </div>
              ...
              <div className="lg:col-span-6 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 space-y-4 font-tech text-xs">
                <div className="flex items-center justify-between text-cyan-400 border-b border-slate-800 pb-2">
                  ...
                  <span className={aegisCongested ? 'text-red-400 font-bold animate-pulse' : 'text-emerald-400'}>
                    ...
                    <div className="w-full bg-slate-950 h-2.5 rounded-full overflow-hidden">
                      <div
                        className={`h-full transition-all duration-300 ${
                          aegisCongested ? 'bg-red-500 w-0' : 'bg-slate-600 w-[10%]'
                        }`}
                      ></div>
                    </div>
                  </div>
                ...
                <div className="pt-2 flex items-center space-x-2">
                  <button
                    ...
                    className={`flex-1 py-2 px-3 rounded-xl font-tech font-bold text-xs transition-all flex items-center justify-center space-x-1.5 ${
                      aegisCongested ? 'bg-amber-600 text-white' : 'bg-slate-800 hover:bg-slate-700 text-cyan-300'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 px-3 rounded-xl font-tech font-bold text-xs transition-all flex items-center justify-center space-x-1.5 ${
                      aegisStarlinkActive ? 'bg-cyan-600 text-white' : 'bg-slate-800 hover:bg-slate-700 text-cyan-300'
                    }`}
                  >
        ...
        {activeEngine === 'molinar' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-6 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 space-y-4 font-tech text-xs">
                <div className="text-cyan-400 border-b border-slate-800 pb-2 flex justify-between">
                  <span>SHELTER TELEMETRY ACQUISITION</span>
                  <span className="text-emerald-400">SENSORS ONLINE</span>
                </div>

                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
                    <div className="text-slate-500 text-[10px]">AMBIENT TEMPERATURE</div>
                    <div className="text-xl font-bold text-cyan-400 mt-0.5">{shelterTemp} °C</div>
                    <div className="text-[9px] text-emerald-400">Optimal (18° - 28°C)</div>
                  </div>

                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
                    <div className="text-slate-500 text-[10px]">LINE VOLTAGE (STABILIZER)</div>
                    <div className="text-xl font-bold text-white mt-0.5">{voltage} V</div>
                    <div className="text-[9px] text-emerald-400">Harmonic Clean (220V ±5%)</div>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
                    ...
                    <div className="text-xl font-bold text-cyan-300 mt-0.5">CLOSED</div>
                    <div className="text-[9px] text-emerald-400">Perimeter Locked</div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 bg-slate-900/80 p-5 rounded-2xl border border-slate-800 space-y-4 font-tech text-xs">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-between">
                    <div>
                      <div className="font-bold text-white text-xs">Relay #1: Edge Core Router Power</div>
                      <div className="text-[10px] text-slate-500">Remote reboot daemon / power cycle</div>
                    </div>
                    <button
                      onClick={() => setRelay1(!relay1)}
                      className={`px-3 py-1.5 rounded-lg font-bold text-xs transition-all ${
                        relay1 ? 'bg-emerald-500 text-white' : 'bg-red-600 text-white'
                      }`}
                    >
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-between">
                    <div>
                      <div className="font-bold text-white text-xs">Relay #2: Auxiliary Cooling Fan</div>
                      <div className="text-[10px] text-slate-500">Thermal management automation</div>
                    </div>
                    <button
                      onClick={() => setRelay2(!relay2)}
                      className={`px-3 py-1.5 rounded-lg font-bold text-xs transition-all ${
                        relay2 ? 'bg-cyan-500 text-white' : 'bg-slate-800 text-slate-400'
                      }`}
                    >
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-between">
                    <div>
                      <div className="font-bold text-white text-xs">Relay #3: Solar / Generator Transfer</div>
