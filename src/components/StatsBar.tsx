  ...
  const stats = [
    {
      value: '99.9%',
      label: { 
        en: 'Operational Availability SLA', 
        id: 'Jaminan Ketersediaan SLA',
        ja: 'SLA 稼働率保証',
        ar: 'ضمان استمرارية الخدمة SLA'
      },
      detail: { 
        en: 'Zero-tolerance uptime for critical operations', 
        id: 'Keandalan infrastruktur tanpa jeda',
        ja: '重要インフラのゼロダウンタイム運用',
        ar: 'جاهزية تشغيلية فائقة للمهام الحرجة'
      },
      icon: Server,
    ...
    },
    {
      value: '180+',
      label: { 
        en: 'Surveillance Nodes Audited', 
        id: 'Kamera CCTV Dikelola',
        ja: '監視カメラノード管理数',
        ar: 'نقاط المراقبة المدارة'
      },
      detail: { 
        en: '22 floors of Kementerian BUMN Tower', 
        id: '22 lantai Menara Kementerian BUMN',
        ja: '国営企業省タワー全22フロア',
        ar: '22 طابقاً في برج وزارة المؤسسات'
      },
      icon: CheckCircle2,
    ...
    },
    {
      value: '512K',
      label: { 
        en: 'Vessel Bandwidth Optimization', 
        id: 'Optimasi Bandwidth Satelit',
        ja: '船舶衛星帯域最適化',
        ar: 'تحسين سعة الأقمار الصناعية'
      },
      detail: { 
        en: 'Empowering 30+ crew on oceanic tankers', 
        id: 'Dikelola efisien untuk 30 awak kapal',
        ja: '外航タンカー乗組員30名以上の通信最適化',
        ar: 'خدمة أكثر من 30 فرداً على ناقلات النفط'
      },
      icon: Clock,
      color: 'text-[#0071E3] dark:text-[#2997FF]',
    },
    {
      value: '10+',
      label: { 
        en: 'Global Tier-1 Certifications', 
        id: 'Sertifikasi Global Tingkat Elit',
        ja: 'グローバル最上位技術資格',
        ar: 'شهادات مهنية عالمية'
      },
      detail: { 
        en: 'Cisco CCNP, Fortinet NSE 7, MikroTik MTCINE', 
        id: 'Cisco CCNP, Fortinet NSE 7, MTCINE',
        ja: 'Cisco CCNP, Fortinet NSE 7, MTCINE',
        ar: 'Cisco CCNP, Fortinet NSE 7, MTCINE'
      },
      icon: Award,
