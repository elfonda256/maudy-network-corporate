...
export const StatsBar: React.FC<StatsBarProps> = ({ lang }) => {
  ...
  return (
    <section className="relative z-20 -mt-8 sm:-mt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-white dark:bg-[#0B1F3A]/95 rounded-2xl p-6 sm:p-8 shadow-xl border border-slate-200 dark:border-cyan-500/20 transition-colors">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className={`text-3xl sm:text-4xl font-extrabold font-mono tracking-tight ${stat.color}`}>
                    {stat.value}
                  </span>
